...
// Path: attachments
class _TranslationsAttachmentsFr extends TranslationsAttachmentsEn {
	_TranslationsAttachmentsFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: setup
class _TranslationsSetupFr extends TranslationsSetupEn {
	_TranslationsSetupFr._(TranslationsFr root) : this._root = root, super.internal(root);
