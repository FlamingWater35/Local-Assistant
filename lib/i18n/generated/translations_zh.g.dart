...
// Path: chat
class _TranslationsChatZh extends TranslationsChatEn {
	_TranslationsChatZh._(TranslationsZh root) : this._root = root, super.internal(root);
...
// Path: attachments
class _TranslationsAttachmentsZh extends TranslationsAttachmentsEn {
	_TranslationsAttachmentsZh._(TranslationsZh root) : this._root = root, super.internal(root);
...
// Path: setup
class _TranslationsSetupZh extends TranslationsSetupEn {
	_TranslationsSetupZh._(TranslationsZh root) : this._root = root, super.internal(root);
...
// Path: download
class _TranslationsDownloadZh extends TranslationsDownloadEn {
	_TranslationsDownloadZh._(TranslationsZh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsRamIndicatorZh extends TranslationsSettingsRamIndicatorEn {
	_TranslationsSettingsRamIndicatorZh._(TranslationsZh root) : this._root = root, super.internal(root);
