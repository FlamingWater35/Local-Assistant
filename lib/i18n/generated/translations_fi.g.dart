...
// Path: chat
class _TranslationsChatFi extends TranslationsChatEn {
	_TranslationsChatFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: attachments
class _TranslationsAttachmentsFi extends TranslationsAttachmentsEn {
	_TranslationsAttachmentsFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: setup
class _TranslationsSetupFi extends TranslationsSetupEn {
	_TranslationsSetupFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: download
class _TranslationsDownloadFi extends TranslationsDownloadEn {
	_TranslationsDownloadFi._(TranslationsFi root) : this._root = root, super.internal(root);
