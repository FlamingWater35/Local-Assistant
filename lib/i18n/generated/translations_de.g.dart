...
// Path: chat
class _TranslationsChatDe extends TranslationsChatEn {
	_TranslationsChatDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: setup
class _TranslationsSetupDe extends TranslationsSetupEn {
	_TranslationsSetupDe._(TranslationsDe root) : this._root = root, super.internal(root);
