...
class ChatHistory extends _$ChatHistory {
  ...
  List<ChatSession> build() {
    try {
      ...
      appLogger.e(
        "Failed to load initial chat history",
        error: e,
        stackTrace: st,
      );
      return [];
...
class ChatLogic extends _$ChatLogic {
  ...
  Future<void> loadSession(String? sessionId) async {
    try {
      ...
      appLogger.e("Error loading session context", error: e, stackTrace: st);
    }
  }
  ...
  Future<void> deleteMessage(String messageId) async {
    ...
    try {
      ...
      if (coreMsg.id.isNotEmpty) state.removeMessage(coreMsg);
  ...
  Future<void> sendMessage(
    ...
    try {
      ...
      try {
        ...
        appLogger.w("Could not enable Wakelock", error: e);
      }
        ...
        (chunk) {
          ...
          if (isFirstChunk) {
            ...
            try {
              ...
              appLogger.d("Typing message already removed", error: e);
            }
            state.insertMessage(
              core.CustomMessage(
                id: aiMsgId,
      ...
      appLogger.e(
        "Failed to prepare and send message",
        error: e,
        stackTrace: st,
      );
  ...
  void _handleGenerationError(
    ...
    try {
      ...
      appLogger.w("Wakelock disable failed", error: e);
    }
    ...
    if (_activeGenerationSessionId == currentSessionId) {
      if (isFirstChunk) {
        try {
          ...
          appLogger.d("Typing msg not found on error", error: e);
        }
      }
    ...
    if (_activeGenerationSessionId == currentSessionId) {
      if (isFirstChunk) {
        try {
          ...
          appLogger.d("Typing msg not found on done", error: e);
        }
      }
      _finalizeActiveStreamMessage();
    }
  ...
  void _finalizeActiveStreamMessage([String? errorText]) {
    try {
      ...
      appLogger.e(
        "Failed to finalize stream message",
        error: e,
        stackTrace: st,
      );
    }
  ...
  Future<void> _cancelActiveGeneration() async {
    try {
      ...
      appLogger.e(
        "Error cancelling active generation",
        error: e,
        stackTrace: st,
      );
    }
  ...
  void _saveSessionToHive() {
    ...
    try {
      ...
      appLogger.e("Failed to save session to Hive", error: e, stackTrace: st);
    }
  }
